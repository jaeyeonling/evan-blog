...
### 흐름 제어의 속도 개선(Deprecated)
{% blockquote %}
  해당 섹션은 IETF의 QUIC 작업 그룹 내에서 Deprecated된 섹션입니다.
  이레이저 코드를 사용한 흐름 제어 방식은 전송 속도 이슈가 발생하여 QUIC 작업 그룹 내에서 Deprecated 되었습니다.
  
  최근 정보는 QUIC 작업 그룹의 [The QUIC Loss Bits](https://datatracker.ietf.org/doc/draft-ferrieuxhamchaoui-quic-lossbits/?include_text=1)에서 확인해보실 수 있으며, 빠른 시일 안에 해당 내용을 수정하도록 하겠습니다.
