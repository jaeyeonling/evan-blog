...
## 마치며
사실 필자가 애자일 코칭을 받고 나서 느낀건 `애자일에는 정답이 없구나`와 동시에 `아니 그럼 저 애자일 선언이고 나발이고 그냥 일만 잘하면 아무 상관없는 거 아닌가?`라는 아이러니한 생각이었다.
...
이 글을 읽는 여러분이 애자일에 관심을 가짐과 동시에 협업에 대한 열정도 뿜뿜하면서 여러분이 팀에서 재밌고 즐겁게 일할 수 있기를 바란다.
